...
class FlowStep(nn.Module):
    ...
    def __init__(self, in_channels, hidden_channels,
        ...
        #将permute 1*1 用ME代替
        #self.emrge=torchtest.invertible_conv2D_emerging(in_channels)
    ...
    def normal_flow(self, z, logdet, rrdbResults=None):
        ...
        #z,logdet=self.emrge(z,logdet,reverse=False)
        ...
        #z,logdet=self.flip(z,logdet=logdet)
        return z, logdet
    ...
    def reverse_flow(self, z, logdet, rrdbResults=None):
        ...
        #z,logdet=self.emrge(z,logdet,reverse=True)
        # 2. permute
        #z,logdet=self.emrge(z,logdet,reverse=True)
        z, logdet = FlowStep.FlowPermutation[self.flow_permutation](
            self, z, logdet, True)
